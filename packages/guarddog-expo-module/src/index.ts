...
// NOTE: an identical copy lives in frontend/src/sdk/nativeModule.ts because Metro cannot
// resolve outside its project root; keep both in sync. (Fixed in Gate Guard M2.1 Phase 5 --
...
// failing. See frontend/src/diagnostics/dnsCapabilityDiagnostic.ts for how this ambiguity is
// preserved (never collapsed into a false "verified Off" claim). ---
