...
BASE_URL = os.environ["EXPO_PUBLIC_BACKEND_URL"].rstrip("/") if os.environ.get("EXPO_PUBLIC_BACKEND_URL") else os.environ.get("EXPO_BACKEND_URL", "https://apollo-patrol.preview.emergentagent.com").rstrip("/")
API = f"{BASE_URL}/api"
