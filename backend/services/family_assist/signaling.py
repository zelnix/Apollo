...
MAX_PENDING = 32
MAX_ICE = 128
ALLOWED = {"offer", "answer", "ice_candidate", "ice_complete", "pause_state", "terminate"}
...
async def serve(websocket: WebSocket, session_id: str, ticket_value: str) -> None:
    ...
    try:
        relay = issue_relay_credentials(session, ticket["device_id"], role)
