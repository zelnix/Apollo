...
const LONG_PATHS = ["/message/extract", "/message/analyse", "/link/investigate", "/page/extract", "/page/crawl", "/voice/speak", "/app/analyse", "/account/analyse", "/intel/check", "/ask/", "/gmail/scan", "/imap/scan", "/imap/connections"];
