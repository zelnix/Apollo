...
const LONG_PATHS = ["/message/extract", "/page/extract", "/page/crawl", "/voice/speak", "/message/analyse", "/app/analyse", "/account/analyse", "/intel/check", "/ask/", "/gmail/scan", "/imap/scan", "/imap/connections"];
