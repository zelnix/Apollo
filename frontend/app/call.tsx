          ...
          <>
            ...
            <View>
              ...
              <Card style={{ gap: spacing.sm }}>
                ...
                <Button testID="call-tell-more" variant="ghost" label="Ask Apollo about this call" onPress={() => router.push({ pathname: "/(tabs)/ask", params: { context: `Phone call check: ${a.title}. State: ${STATE_NAME[a.state]}. Caller claimed: ${a.claimedBrand ?? claim}. Asked for: ${a.requestedActions.join(", ")}.`, prompt: "What should I do about this phone call?" } })} />
