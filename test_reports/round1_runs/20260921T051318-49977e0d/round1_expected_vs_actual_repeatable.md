...
Generated: 2026-09-21T05:13:18.737728+00:00
Browser target: `None`
...
- Browser journeys: **0/10 complete**, **0 partial**, **0 failed**, **0 blocked**, **10 not run**
...
| `device-legitimate-observed` | device | legitimate | resting; Apollo protection; operational; must not: threat was blocked, all apps were inspected | resting; Apollo protection is confirmed running; The device reported protection operational at 05:13 AM. | COMPLETE |
...
|---|---|---|---|---|---|
| `not-run-site` | site | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-link` | link | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-text` | text | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-call` | call | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-network` | network | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-account` | account | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-email` | email | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-app` | app | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-file` | file | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |
| `not-run-device` | device | Catalogue journey | Run the normal user journey. | Browser execution was skipped. | NOT_RUN |

## Journey details — what the user actually saw

### `not-run-site` — NOT_RUN

- **Expected:** Run the normal user journey.
- **User saw:** Browser execution was skipped.
- **Cause/gap:** None observed in this run.
- **Artifact:** `None`

### `not-run-link` — NOT_RUN
...
- `not-run-site` — **NOT_RUN**: Browser execution was skipped.
- `not-run-link` — **NOT_RUN**: Browser execution was skipped.
- `not-run-text` — **NOT_RUN**: Browser execution was skipped.
- `not-run-call` — **NOT_RUN**: Browser execution was skipped.
- `not-run-network` — **NOT_RUN**: Browser execution was skipped.
- `not-run-account` — **NOT_RUN**: Browser execution was skipped.
- `not-run-email` — **NOT_RUN**: Browser execution was skipped.
- `not-run-app` — **NOT_RUN**: Browser execution was skipped.
- `not-run-file` — **NOT_RUN**: Browser execution was skipped.
- `not-run-device` — **NOT_RUN**: Browser execution was skipped.
