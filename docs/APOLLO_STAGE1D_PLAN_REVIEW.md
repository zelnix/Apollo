...
- `STAGE1D_CANDIDATE_RECORD.md` is the authoritative pre-install record. It must receive the final source SHA, build ID and APK hash before installation, then the Pixel run ID/results during acceptance.
